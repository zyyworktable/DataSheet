...
- 美股自选股支持盘前（纽约时间 04:00–09:30）与盘后（16:00–20:00）价格，扩展时段由 Yahoo 批量行情补充，自动处理美国夏令时；固定美股指数仍显示常规指数行情。
...
美股盘前和盘后的流动性通常低于常规时段。界面的“状态”列会明确显示“盘前”“盘后”或“待更新”，鼠标悬停可查看价格阶段和实际行情来源；扩展时段价格仅适用于有成交的美股或 ETF。
